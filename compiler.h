...
struct cc_load_constant : public compiler_command {
    ...
    cc_load_constant(vbyte target_register, int64_t value, bit_width width)
...
struct cc_alu_const_operation : public compiler_command {
    ...
    vbyte _out_register;
    vvalue _value;
    cc_alu_const_operation(vbyte in_register, vbyte out_register, vvalue value)
            : _in_register(in_register), _out_register(out_register), _value(value) {}
    cc_alu_const_operation(vbyte in_register, vbyte out_register, int64_t value, bit_width width)
...
struct cc_alu_const_add : public cc_alu_const_operation {
    virtual vbyte command() const { return CMD_ALU_ADD_CONST; }
    cc_alu_const_add(vbyte in_register, vbyte out_register, vvalue value)
            : cc_alu_const_operation(in_register, out_register, value) {}
    cc_alu_const_add(vbyte in_register, vbyte out_register, int64_t value, bit_width width)
            : cc_alu_const_operation(in_register, out_register, value, width) {}
};

struct cc_alu_const_subtract : public cc_alu_const_operation {
    virtual vbyte command() const { return CMD_ALU_SUB_CONST; }
    cc_alu_const_subtract(vbyte in_register, vbyte out_register, vvalue value)
            : cc_alu_const_operation(in_register, out_register, value) {}
    cc_alu_const_subtract(vbyte in_register, vbyte out_register, int64_t value, bit_width width)
            : cc_alu_const_operation(in_register, out_register, value, width) {}
};
...
public:
    ...
    void setIndex(const std::string &label, vbyte* pos, size_t offset, bit_width width) {
